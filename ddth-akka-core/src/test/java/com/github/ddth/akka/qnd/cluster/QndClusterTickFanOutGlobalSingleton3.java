...
public class QndClusterTickFanOutGlobalSingleton3 extends BaseQnd {
    private static Logger LOGGER = LoggerFactory.getLogger(QndClusterTickFanOutGlobalSingleton3.class);
    ...
    static abstract class MyWorker extends BaseClusterWorker {
        ...
        protected void doJob(String lockId, TickMessage tick) throws Exception {
            ...
            try {
                String id = getCluster().selfMember().address() + ":" + self().path().name();
                LOGGER.info("{" + id + "}: " + tick.getId() + " / " + DateFormatUtils
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.err.println("Starting actor system 1...");
        {
            ...
            actorSystem1 = startActorSystem(config1, MasterActor.class, MyWorker1.class, MyWorker2.class,
        ...
        System.err.println("Starting actor system 2...");
        {
            ...
            actorSystem2 = startActorSystem(config2, MasterActor.class, MyWorker1.class, MyWorker2.class,
                    ClusterTickFanOutActor.class);
        }
